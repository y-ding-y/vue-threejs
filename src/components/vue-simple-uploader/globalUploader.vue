            ...
            <uploader-list v-show="panelShow">
                <div class="file-panel" slot-scope="props" :class="{'collapse': collapse}">
                    <div class="file-title">
                        <h2>文件列表</h2>
                        <div class="operate">
                            <a-button @click="fileListShow" type="text" :title="collapse ? '展开':'折叠' ">
                                <i class="iconfont" :class="collapse ? 'inuc-fullscreen': 'inuc-minus-round'"></i>
                            </a-button>
                            <a-button @click="close" type="text" title="关闭">
        ...
        methods: {
            ...
            computeMD5(file) {
                ...
                fileReader.onload = (e => {
                    ...
                    console.log(new Blob([e.target.result],{type: 'model/gltf-binary'}) )
                    console.log(e)
